...
file_path = 'C:/Users/Corrupted/Desktop/S_data'  # folder directory
good_path = 'C:/Users/Corrupted/Desktop/S_Sorted_data/S_Good'  # good path
bad_path = 'C:/Users/Corrupted/Desktop/S_Sorted_data/S_Bad'  # bad path
...
class MyGUI():
    ...
    def __init__(self):
        ...
        # tk.Label(button_frame, text=len(os.listdir(good_path)),background='SpringGreen2').grid(row=1,column=0,sticky=tk.W+tk.E)
        # tk.Label(button_frame, text=len(os.listdir(bad_path)),background='firebrick1').grid(row=1,column=1,sticky=tk.W+tk.E)
        # tk.Label(button_frame, text=len(l)).grid(row=1,column=2,sticky=tk.W+tk.E)
        

        self.des = tk.Label(button_frame, text='Welcome', background='coral')
        self.des.grid(row=1,column=3,sticky=tk.W+tk.E)
